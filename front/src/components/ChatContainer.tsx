...
//   const handelSendImage = async (e: any) => {
...
//         <p
//           onClick={() => setSelectedUsers(null)}
//           className="hidden md:inline-block px-2 py-1 rounded-xl bg-green-400 text-white cursor-pointer"
//         >
//           X
//         </p>
//       </div>
...
//                 src={msg.image}
//                 alt="message-img"
//                 className="rounded-xl border border-gray-700 mb-8 max-w-[230px] object-contain"
//               />
//             ) : (
//               <p
//                 className={`p-2 text-sm font-light rounded-lg mb-8 bg-violet-500/30 text-white max-w-[200px] ${
...
//             className="outline-none  border-none bg-transparent flex-1 p-3 text-sm text-white placeholder-gray-400"
//           />
//         </div>
//         <input
//           type="text"
...
//           alt="Send"
//           className="w-7 h-7 mb-3 cursor-pointer"
//         />
//       </div>
//     </div>
//   ) : (
